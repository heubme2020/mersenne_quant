...
class THREE(nn.Module):
    ...
    def forward(self, x):
        ...
        growth_death_one = self.decoder_one(encoder)
        growth_death_three = self.decoder_three(encoder)
        growth_death_seven = self.decoder_seven(encoder)
        return growth_death_one, growth_death_three, growth_death_seven
